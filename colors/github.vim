...
" {{{ Cursor
hi Cursor		guibg=#444454 guifg=#F8F8F8
...
hi LineNr		guifg=#959595 guibg=#F4F4F4 gui=bold
hi NonText		guifg=#808080 guibg=#F4F4F4
hi Folded		guifg=#808080 guibg=#F4F4F4 gui=bold
hi FoldeColumn  guifg=#808080 guibg=#F4F4F4 gui=bold
